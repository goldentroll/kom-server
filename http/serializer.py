...
class Serializer(k.Module):
    ...
    def test(cls, size=1):
        ...
        stats['elapsed_time'] = k.time() - t
        stats['size_bytes'] = k.sizeof(data)
        stats['size_bytes_compressed'] = k.sizeof(serialized_data)
        stats['size_deserialized_data'] = k.sizeof(deserialized_data)
        stats['compression_ratio'] = stats['size_bytes'] / stats['size_bytes_compressed']
        stats['mb_per_second'] = k.round((stats['size_bytes'] / stats['elapsed_time']) / 1e6, 3)
        k.print(stats)
