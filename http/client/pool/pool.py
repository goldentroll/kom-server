...
class ModulePool (k.Module):
    ...
    async def async_add_module(self, module:str = None, timeout=3)-> str:
        print(module)
        self.modules[module] = await k.async_connect(module, timeout=timeout,virtual=False)
    ...
    async def async_get_module( self, 
        ...
        if module == None:
             module = k.choice(list(self.modules.values()))
